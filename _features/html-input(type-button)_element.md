---
{
  ...
  "links": {
    "WHATWG HTML spec for input[type=\"button\"]": "https://html.spec.whatwg.org/multipage/input.html#button-state-(type=button)",
    "HTML AAM for the input[type=\"button\"]": "https://w3c.github.io/html-aam/#el-input-button"
  }
}
---